          ...
          <div className="">
            <div className="grid md:grid-cols-6 lg:grid-cols-9 grid-cols-1 gap-7 border-b border-solid border-white/50 pb-11">
              <div className="col-span-3">
                <h2 className="text-white text-[40px] leading-tight font-bold">Starter<br /> head office</h2>
              </div>
              <div className="col-span-3">
                <p className="sm:text-2xl text-xl text-IceBlue font-normal max-w-64 leading-10 text-white/50">24 Iyalla Street, Behinde Shprite, Ikeja, Lagos State.</p>
              </div>
              <div className="col-span-3">
                <Link href="mailto:headoffice@Essential.com" className="sm:text-2xl text-xl text-white font-medium underline">headoffice@Essential.com</Link>
            ...
            <div className="grid md:grid-cols-6 lg:grid-cols-9 grid-cols-1 gap-7 pt-12">
              <div className="col-span-3">
                <h2 className="text-white max-w-52 text-[40px] leading-tight font-bold">Head office</h2>
              </div>
              <div className="col-span-3">
              ...
              <div className="col-span-3">
                <Link href="mailto:office@Essential.com" className="sm:text-2xl text-xl text-white font-medium underline">office@Essentialng.com</Link>
